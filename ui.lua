...
local Library do 
    ...
    Components.Slider = function(Data)
        ...
        function Slider:Set(Value)
            ...
            local ratio = range > 0 and MathClamp((Slider.Value - Data.Min) / range, 0, 1) or 0
            Items["Indicator"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2New(ratio, 0, 1, 0)})
